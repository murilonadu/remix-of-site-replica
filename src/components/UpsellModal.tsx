...
const UpsellModal = ({
  ...
  const handleAcceptClick = () => {
    if (selectedPlan === 'premium') {
      redirectWithParams("https://ggcheckout.app/checkout/v2/1TMlLGIlBL86oXifTspo");
    } else {
      redirectWithParams("https://ggcheckout.app/checkout/v2/wd9P6h8Tff6K2A1F2FFt");
    }
  };
  const handleDeclineClick = () => {
    if (selectedPlan === 'premium') {
      ...
      redirectWithParams("https://ggcheckout.app/checkout/v2/tKt9vSrCBlVBoTUOW44e");
    }
  };
                  ...
                  <div className="mt-2 bg-gradient-to-b from-[#2d4a3e] to-[#1a3028] rounded-lg py-3 px-4">
                    <div className="flex flex-col items-center gap-0.5">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-2xl font-black text-amber-400">R$ 17,00</span>
                      </div>
                    </div>
                  </div>
                </div>
