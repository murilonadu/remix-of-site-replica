      ...
      <div className="container mx-auto px-4 py-10 md:py-20 relative z-10">
        <div className="text-center space-y-8">
          ...
          <div className="mt-8 md:mt-12 flex justify-center animate-fade-in animation-delay-1000">
            <img src={productMockup} alt="Pack Marceneiro Rico" className="w-80 md:w-[420px] lg:w-[500px] h-auto drop-shadow-2xl hover:scale-105 transition-transform duration-300" />
          </div>
