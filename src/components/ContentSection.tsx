              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 text-sm">Planos de corte otimizados para zero desperdício.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 text-sm">Projetos organizados por rentabilidade.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 text-sm">Abra, mostre ao cliente e feche na hora.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 text-sm">Projetos modernos, atualizados e prontos para execução.</p>
                  </div>
                </div>
              </div>
            </div>
