  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-dynamic-green': 'var(--gradient-dynamic-green)',
        'gradient-title-glow': 'var(--gradient-title-glow)',
        'gradient-title-primary': 'var(--gradient-title-primary)',
        'gradient-title-accent': 'var(--gradient-title-accent)',
